...
The findings themselves are aggregate conclusions, not licensed rows, but they are written
into the nginx-guarded aggregate so the whole intel surface sits behind one gate.
...
INSIGHTS = {
  ...
  "sources": [
    {
      "id": "pdi",
      "name": "PDI Point-of-Sale",
      "kind": "Retail scan data",
    ...
    {
      "id": "simmons",
      "name": "Simmons Brand Profiles",
      "kind": "Consumer profiling",
  ...
  "insights": [
    {
      "src": "usda",
      "tier": "headline",
      "title": "The shelf is one formula repeated 1,300 times",
    ...
    },
    {
      "src": "usda",
      "tier": "headline",
      "title": "Functional ingredients consumers ask for are almost absent",
    ...
    },
    {
      "src": "usda",
      "tier": "support",
      "title": "Sweetener choice is synthetic by default",
    ...
    },
    {
      "src": "mintel_survey",
      "tier": "headline",
      "title": "Consumers rank 'natural' above 'sugar-free'",
    ...
    },
    {
      "src": "mintel_survey",
      "tier": "support",
      "title": "Gen X wants 'natural' more than Gen Z does",
    ...
    },
    {
      "src": "mintel_survey",
      "tier": "support",
      "title": "Function and taste are joint first, not a trade-off",
    ...
    },
    {
      "src": "gnpd",
      "tier": "headline",
      "title": "Sugar-free is table stakes, not white space",
    ...
    },
    {
      "src": "gnpd",
      "tier": "support",
      "title": "Beauty-function appeared from nothing",
      ...
      "metric": "0% → 10.6% in six years"
    },
    {
      "src": "pdi",
      "tier": "headline",
      "title": "Only 6% of new brands ever reach $1M",
    ...
    },
    {
      "src": "pdi",
      "tier": "headline",
      "title": "You cannot enter with a single SKU",
    ...
    },
    {
      "src": "pdi",
      "tier": "headline",
      "title": "'Original' flavour is bleeding share to fruit",
    ...
    },
    {
      "src": "pdi",
      "tier": "support",
      "title": "A third of revenue sits in one price band",
    ...
    },
    {
      "src": "pdi",
      "tier": "support",
      "title": "Regional strongholds are real",
    ...
    },
    {
      "src": "simmons",
      "tier": "headline",
      "title": "No legacy brand reaches the genuinely health-conscious",
    ...
    },
    {
      "src": "passport",
      "tier": "support",
      "title": "Two brands own two thirds of the market",
    ...
    },
    {
      "src": "mulo",
      "tier": "headline",
      "title": "Alani Nu is the breakout, and social data missed it",
    ...
    },
    {
      "src": "combined",
      "tier": "headline",
      "title": "The convergent thesis: natural + functional, priced at $0.25–0.30/oz",
    ...
    },
    {
      "src": "combined",
      "tier": "support",
      "title": "Strawberry is the most over-launched flavour",
  ...
  "er": {
    "tables": [
      ...
      {
        "id": "usda_branded_foods",
        "label": "usda_branded_foods",
        "src": "usda",
        "rows": "18.6K",
        "cols": [
          "gtin_upc",
      ...
      {
        "id": "mintel_survey_data",
        "label": "mintel_survey_data",
        "src": "mintel_survey",
        "rows": "539K",
        "cols": [
          "question_id",
      ...
      {
        "id": "simmons_brand_profiles",
        "label": "simmons_brand_profiles",
        "src": "simmons",
        "rows": "603",
        "cols": [
          "brand",
      ...
      {
        "id": "passport_brand_shares",
        "label": "passport_brand_shares",
        "src": "passport",
        "rows": "210",
        "cols": [
          "brand",
      ...
      {
        "id": "mintel_mulo_brand_sales",
        "label": "mintel_mulo_brand_sales",
        "src": "mulo",
        "rows": "15",
        "cols": [
          "brand",
    ...
    "edges": [
      ...
      {
        "a": "pdi_energy_drinks_monthly",
        "b": "brand_crosswalk",
        "on": "canonical_brand",
        "kind": "strong",
        "label": "canonical_brand"
      },
      {
        "a": "pdi_master_gtin",
        "b": "usda_branded_foods",
        "on": "GTIN = gtin_upc",
        "kind": "fuzzy",
        "label": "barcode (padding differs)"
      },
      {
        "a": "brand_crosswalk",
        "b": "gnpd_products",
      ...
      {
        "a": "brand_crosswalk",
        "b": "mintel_mulo_brand_sales",
        "on": "brand",
        "kind": "fuzzy",
        "label": "brand name"
      },
      {
        "a": "mintel_survey_data",
        "b": "gnpd_products",
        "on": "no key — compared conceptually",
        "kind": "none",
        "label": "no join key"
      }
    ]
